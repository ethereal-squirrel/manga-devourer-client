...
export default function OauthDropboxScreen() {
  const { setOauthDropboxAccessToken, setOauthDropboxRefreshToken } =
    useCommonStore();
  ...
  useEffect(() => {
    ...
    if (refreshToken) {
      setOauthDropboxRefreshToken(refreshToken);
    }
